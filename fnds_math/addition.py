import random
from general_resource.fnds_functionality import Avg_TTA, AnswerTracker, ScreenManager  # Importing the necessary modules and classes
...
class Addision_game:
    ...
    def game_loop(self, score, Panel, console):
        response = "run"
        timer = Avg_TTA()
